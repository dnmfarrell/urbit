:: library with modified copy of hoon.hoon for doccords experiments
::
=>  %140  =>
::                                                      ::
::::    0: version stub                                 ::
...
++  vast                                                ::  main parsing core
  ...
  ++  norm                                              ::  rune regular form
    ...
    ++  expression
      ...
      ==
    ::
    :: doccords TODO: modify this to call apex:docs somewhere
    ++  boog  !:                                        ::  core arms
      %+  knee  [p=*term q=*hoon]  |.  ~+
      ;~  pose
        ;~  pfix  (jest '++')
  ...
  ++  tall                                              ::  full tall form
    ...
    |.(~+((wart ;~(pose expression:(norm &) long lute))))
    ::
    ::
  ++  till                                              ::  mold tall form
    %+  knee  *spec
